...
/**
 * com.oddNumber.OddNumbersIterator iterator class.
 *
 * @author Vihovsky Roman
 * @since 17.04.2017
 */
public class OddNumbersIterator implements Iterator {
    /**
     ...
     */
    public OddNumbersIterator(final int[] values) {
        this.values = values;
    }
    ...
    public Object next() throws NoSuchElementException {
        ...
        /**
         *  If last element of array even.
         */
        if ((this.index == dataLength() + 1) & ((values[this.index] % 2) == 0)) {
            this.index++;
        }
        /**
         * Print last odd element (important).
         */
